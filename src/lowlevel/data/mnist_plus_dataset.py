...
class MNISTPLUSDataset(MNISTDataset):
	...
	def __str__(self):
		return 'domains: 2, num_points: {}, domain_x {}'.format(self.num_data_points, super(MNISTPLUSDataset, self).__str__())
	...
	def __getitem__(self, index):
		...
		return {'domain_a': super(MNISTPLUSDataset, self).__getitem__(self.domain_a[index]),\
				 'domain_b': super(MNISTPLUSDataset, self).__getitem__(self.domain_b[index]), \
				 'y_label': self.to_one_of_k(int(self.y_label[index]), 19)}