...
class MNISTBLANDDataset(MNISTDataset):
	...
	def __str__(self):
		return 'domains: 2, num_points: {}, domain_x {}'.format(self.num_data_points, super(MNISTBLANDDataset, self).__str__())
	...
	def __getitem__(self, index):
		...
		return {'domain_a': super(MNISTBLANDDataset, self).__getitem__(self.domain_a[index]),\
				 'domain_b': super(MNISTBLANDDataset, self).__getitem__(self.domain_b[index]), \
