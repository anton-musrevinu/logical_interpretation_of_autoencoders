...
class MNISTEXAMPLELOGICDataset(MNISTEXAMPLEDataset):
	def __init__(self, opt, type_of_data, mydir = None,\
		 ...
		 relational_func = lambda a,b: a and b,\
		  ...
		  y_classes = 2):
		MNISTEXAMPLEDataset.__init__(self, opt, type_of_data, mydir)
	...
	def __str__(self):
		return 'domains: 2, y_classes: {}, num_points: {}, domain_x {}'.format(self.y_classes, self.num_data_points, super(MNISTEXAMPLELOGICDataset, self).__str__())
	...
	def __getitem__(self, index):
		...
		return {'domain_a': super(MNISTEXAMPLELOGICDataset, self).__getitem__(self.domain_a[index]),\
				 'domain_b': super(MNISTEXAMPLELOGICDataset, self).__getitem__(self.domain_b[index]), \
